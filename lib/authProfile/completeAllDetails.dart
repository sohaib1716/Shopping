...
class completeAllDetails extends StatefulWidget {
  ...
  completeAllDetails(this.isCheckout);

  @override
  _completeAllDetailsState createState() =>
      _completeAllDetailsState(isCheckout);
}
...
class _completeAllDetailsState extends State<completeAllDetails> {
  ...
  _completeAllDetailsState(this.isCheckout);
    ...
    setState(() {
      if (step == 1) {
        ...
        if (validateField(context, address1Controller, 15, "default",
                "Please provide correct delivery address.") &&
  ...
  Future<void> sendUserData() async {
    ...
    await post(Config.mainUrl + Config.addUserDetails, body: {
      "uid": userId,
